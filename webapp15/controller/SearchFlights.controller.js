sap.ui.define([
    ...
    return Controller.extend("ui5.rest.restwithui5.controller.SearchFlights", {
        ...
        onPatternMatched: function (oEvent) {
            ...
            oView.getModel().setProperty("/SelectedTime", this.time[0]);
        ...
        clearFilter: function () {
            ...
            oBinding.filter([]);
            oView.getModel().setProperty("/queryCompany", null);
            oView.getModel().setProperty("/queryMinSeats", null);
            oView.getModel().setProperty("/SelectedTime", null);
        ...
        onRefreshButtonPress: function (oEvent) {
            ...
            const oData = oEvent.getSource().data();
            console.log(oData);
            // const o = oEvent.getSource().data("srcAirportCode");
            // const oData = oEvent.getSource().data("srcAirportCode");
            console.log(oData.srcAirportCode, oData.destAirportCode, oData.date)
            const formattedDate = oData.date.split("/").reverse().join("-");
            this.DataRepository.getFlights(oData.srcAirportCode, oData.destAirportCode, formattedDate);
        },
        onFilterButtonPress: function (oEvent) {
            ...
            if (selectedTime) {
                let selectedTime = this.getView().getModel().getProperty("/SelectedTime");
                console.log("selectedTime", selectedTime);
                console.log(typeof (selectedTime) == "object");
                ...
                console.log(selectedTimeObjArr);
        ...
        toggleFiltersDisplay: function (oEvent) {
            const filters = this.getView().byId("filters");
            filters.toggleStyleClass("hideOnTablet");
        },
